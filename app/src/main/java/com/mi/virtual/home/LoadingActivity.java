...
import com.mi.virtual.widgets.EatBeansView;
...
public class LoadingActivity extends VActivity {
    ...
    public static boolean launch(Context context, String packageName, int userId) {
        ...
        if (intent != null) {
            Log.d("kkkk", "==LoadingActivity=launch=");
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("kkkk", "==LoadingActivity=onCreate=");
...
//        }
    ...
    private void launchActivity(Intent intent, int userId) {
        try {
            Log.d("kkkk", "==launchActivity==666666666666666666==" + System.currentTimeMillis() / 1000);
