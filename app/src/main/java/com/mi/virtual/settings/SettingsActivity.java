package com.mi.virtual.settings;
...
import com.mi.virtual.OpenAppActivity;
import com.mi.virtual.R;
import com.mi.virtual.VCommends;
import com.mi.virtual.home.LauncherFiles;
import com.mi.virtual.home.ListAppActivity;
import com.mi.virtual.utils.Misc;
...
public class SettingsActivity extends Activity {
    ...
    private static final String APP_LIST_INSTALLED = "app_list_installed";
    ...
    public static class SettingsFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            Preference appInstalled = findPreference(APP_LIST_INSTALLED);
            ...
            appInstalled.setOnPreferenceClickListener(preference -> {
                startActivity(new Intent(getActivity(), OpenAppActivity.class));
                return false;
            });
